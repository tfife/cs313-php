...
<body background="images/triangles.jpg">
    ...
    <div class="bodyBox" style="text-align: left">
        ...
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            ...
            Address Line 1<br><input type="text" name="addr1" value="<?php echo $addr1;?>"><span class="error">* <?php echo $addr1Err;?></span><br>
            Address Line 2<br><input type="text" name="addr2" value="<?php echo $addr2;?>"><br>
